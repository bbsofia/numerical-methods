...
class ErrorWindow(QWidget):
    ...
    def show(self, message):      
        ...
        QMessageBox.question(self, 'Error', message, QMessageBox.Ok)
...
class Window(QWidget):
    ...
    def __init__(self, error):
        ...
        self.setWindowTitle("Sprint01")
        self.setWindowIcon(QIcon('./t07/assets/images/icon.png'))
        self.setStyleSheet(open('/home/vip/Стільниця/Sprint01_num_method/t07/assets/css/style.css').read())
    ...
    def initUI(self):
        ...
        # Background
        img = QImage("/home/vip/Стільниця/Sprint01_num_method/t07/assets/images/background.jpeg")
        ...
        self.line.setGeometry(600, 150, 200, 80)
        self.line.setFocus()
        ...
        self.file.setGeometry(600, 400, 200, 50)
